...
class CoarseMatching(Module):
    ...
    def forward(
        ...
        data.update({'conf_matrix': conf_matrix, 'feat_c0': feat_c0, 'feat_c1': feat_c1})
    ...
    def get_coarse_match(self, conf_matrix: Tensor, data: Dict[str, Tensor]) -> Dict[str, Tensor]:
        ...
        feat_c0 = data['feat_c0'][b_ids, i_ids, :]
        feat_c1 = data['feat_c1'][b_ids, j_ids, :]
        ...
        coarse_matches.update(
            {
                ...
                'mconf': mconf[mconf != 0],
                'feat_c0': feat_c0[mconf != 0],
                'feat_c1': feat_c1[mconf != 0],
            }
        )
